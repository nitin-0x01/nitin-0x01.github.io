  ...
  const getThemeStyles = () => {
    switch (activeTheme) {
      case 'cyber':
        return {
          ringGradient:
            'from-purple-500 via-cyan-400 to-indigo-600',
      ...
      case 'hologram':
        return {
          ringGradient:
            'from-blue-400 via-teal-300 to-emerald-500',
  ...
  return (
    ...
    >
      ...
      <div className="relative w-72 h-72 sm:w-88 sm:h-88 lg:w-96 lg:h-96">
        ...
        {/* Outer Frame Wrapper */}
        <div
          className={`relative w-full h-full rounded-3xl p-1 bg-gradient-to-tr ${
            currentStyle.ringGradient
          } shadow-2xl overflow-hidden transition-all duration-700`}
        >
            ...
            <div className="w-full h-full relative flex items-center justify-center bg-gradient-to-b from-gray-900 via-gray-950 to-black">
              ...
              {displayImage && !imageError ? (
                ...
                >
                  ...
                  {/* Circuit Lines */}
                  <path
                    d="M 50 100 Q 100 80 200 120 T 350 100"
                  ...
                  <path
                    d="M 30 250 Q 150 220 250 280 T 370 240"
                    stroke="rgba(255,255,255,0.08)"
                    strokeWidth="1.5"
                    strokeDasharray="4 4"
                  />
                  ...
                  {/* Shirt Collar */}
                  <path
                    d="M 160 285 L 200 330 L 240 285"
                    fill="#451a03"
                    stroke="#2a0d02"
                    strokeWidth="2"
                  />
                  ...
                  <path
                    d="M 175 285 L 200 320 L 225 285"
                    fill="#f87171"
                    opacity="0.3"
                  />
                  ...
                  {/* Nose */}
                  <path
                    d="M 198 135 L 202 165 L 194 168 Q 200 172 206 168"
                    stroke="#a3623b"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                    fill="none"
                  ...
                  {/* Mustache */}
                  <path
                    d="M 180 182 Q 200 177 220 182 Q 200 187 180 182 Z"
                    fill="#111827"
                  />

                  {/* Beard */}
                  <path
                    d="M 185 190 Q 200 196 215 190"
                    stroke="#a3583b"
                    strokeWidth="3"
                    strokeLinecap="round"
                    fill="none"
                  ...
                  {activeTheme === 'cyber' && (
                    <g opacity="0.85">
                      <path
                        d="M 150 133 L 188 133 L 183 145 L 155 145 Z"
                      ...
                      <path
                        d="M 212 133 L 250 133 L 245 145 L 217 145 Z"
                        fill="rgba(56, 189, 248, 0.2)"
                        stroke="#38bdf8"
                        strokeWidth="1.5"
                      />
              ...
              <div className="absolute bottom-3 left-3 right-3 p-3 rounded-2xl bg-gray-950/80 border border-purple-500/30 backdrop-blur-md">
                <div className="text-xs font-bold text-white flex items-center justify-between">
                  ...
                  <span
                    className={`text-[10px] font-mono px-1.5 py-0.5 rounded ${currentStyle.badgeText} bg-gray-900 border ${currentStyle.badgeBorder}`}
                  >
                    {currentStyle.tag}
                  </span>
                </div>
